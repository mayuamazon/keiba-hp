...
3. SEO見出し構成を設計：h1（タイトル）→ リード → h2複数（コース特性 / 枠順傾向 / 脚質傾向 / 人気傾向 / **得意な騎手** / **得意な厩舎（美浦・栗東の別含む）** / 歴代勝ち馬 / 今年の注目ポイント）→ 必要に応じ h3。騎手・厩舎はファクトシートに母数付きデータがある場合のみh2を立てる（無ければ作らない）。**血統のh2は作らない（データ無し）**。
